...
public class Main {
    public static void main(String[] args) {
        ...
        //Substring
        String kata = kalimat.substring(10,15); // ini heap biasa
        ...
        kata  = kata + " cireng"; //ini string pool
        System.out.println(kata);
        ...
        String gorengan1 = "bakwan"; //ba sama sehingga perhitungan alphabet dihitung dari yang berbeda
        ...
        //untuk string pool yang di cek addressnya walaupun isinya sama tetapi addressnya berbeda maka dia akan false

        System.out.println("\npersamaaan pada lokasi string pool");
        ...
        kataInput =  userInput.next(); // tidak sama, karena ini tidak di string pool
